...
- You can click on the toolbar to open files.
- If you set Emacs as your default editor, then you can open files by double clicking them in your operating system's native file manager.
...
3. Use =C-x b== to switch buffers. You can also left/right click on the buffer name to cycle buffers.
...
- eshell is a shell in Emacs Lisp
